...
concatenated_dialogue = keras.layers.concatenate([encoded_context_2, encoded_context_1, encoded_context_0, encoded_reply])
reshaped_dialogue = Reshape((4, 200))(concatenated_dialogue)

vertical_gru = GRU(200)(reshaped_dialogue)


drop0 = Dropout(0.4)(vertical_gru)
