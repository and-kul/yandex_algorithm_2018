...
lstm_layer_1 = Bidirectional(LSTM(100, return_sequences=True), merge_mode="concat")
lstm_dropout = Dropout(0.4)
lstm_layer_2 = Bidirectional(LSTM(100), merge_mode="concat")


encoded_context_2 = lstm_layer_2(lstm_dropout(lstm_layer_1(get_context_2)))
encoded_context_1 = lstm_layer_2(lstm_dropout(lstm_layer_1(get_context_1)))
encoded_context_0 = lstm_layer_2(lstm_dropout(lstm_layer_1(get_context_0)))
encoded_reply = lstm_layer_2(lstm_dropout(lstm_layer_1(get_reply)))
