...
from keras.layers import Input, LSTM, Dense, Dropout, Lambda, GRU
...
encoded_context_2 = shared_gru(get_context_2)
encoded_context_1 = shared_gru(get_context_1)
encoded_context_0 = shared_gru(get_context_0)
encoded_reply = shared_gru(get_reply)
